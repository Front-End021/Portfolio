      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary via-secondary to-primary/30 transform -translate-x-1/2" />

            {experiences.map((exp, index) => (
              <div
                key={exp.organization}
                className={`relative mb-12 md:mb-16 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:ml-auto'} md:w-1/2`}
              >
                {/* Timeline dot */}
                <div className="absolute left-0 md:left-auto md:right-0 top-0 w-4 h-4 bg-primary rounded-full transform -translate-x-1/2 md:translate-x-1/2 shadow-[0_0_15px_hsl(var(--primary))]" />
